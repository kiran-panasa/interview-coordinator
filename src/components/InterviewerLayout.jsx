    ...
    <div className="flex min-h-screen bg-gray-50">
      <aside className="w-60 bg-white border-r border-gray-200 flex flex-col fixed inset-y-0">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest px-2 mb-2">Interviewer</p>
          {NAV.map(item => (
        ...
        <div className="px-4 py-4 border-t border-gray-100">
          <p className="text-xs font-semibold text-emerald-600 truncate">{userProfile?.displayName || userProfile?.email}</p>
          <p className="text-xs text-gray-400 mb-3">Interviewer</p>
